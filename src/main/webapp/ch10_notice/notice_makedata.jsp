...
<head>
  <%
    ...
    String query1 = "drop table notice;";
    PreparedStatement pstmt = conn.prepareStatement(query1);
    pstmt.executeUpdate();


    String query2 = "CREATE TABLE notice(id int NOT NULL PRIMARY KEY AUTO_INCREMENT, title varchar(70), date date, content text) DEFAULT CHARSET UTF8;";
    pstmt = conn.prepareStatement(query2);
    pstmt.executeUpdate();
    

    String query3 = "insert into notice(title, date, content) values(?, ?, ?);";
